...
public class PostContentsView_requestActivity extends AppCompatActivity {
        ...
        viewImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(chkimgloaded){
                    ...
                    Intent showImgIntent = new Intent(PostContentsView_requestActivity.this,PostImgView.class);
                    ...
                    Toast.makeText(PostContentsView_requestActivity.this, "이미지를 로딩중입니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                if(!ismatched.equals("default")){
                    ...
                    if(chkmyPosition){
                        ...
                        if(ismatched.equals(mUid)){
                            ...
                            Toast.makeText(PostContentsView_requestActivity.this, "Current Time is : "+currentTime, Toast.LENGTH_SHORT).show();
                            ...
                            if(chktime){
                                ...
                                missionCancelbtn.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(PostContentsView_requestActivity.this, "취소할 수 있도록 채팅방으로 이동합니다.", Toast.LENGTH_SHORT).show();
                                        chatCheck_helper();
                                    }
                                });
    ...
    private void goTochklikes() {
        ...
        if (flag == true) {
            ...
            Toast.makeText(PostContentsView_requestActivity.this, "관심목록에서 삭제되었습니다.", Toast.LENGTH_SHORT).show();
            flag = false;
        } else {
            mylike.setImageResource(R.drawable.heart_icon);
            ...
            Toast.makeText(PostContentsView_requestActivity.this, "관심목록에 추가되었습니다.", Toast.LENGTH_SHORT).show();
            flag = true;
        }
        Log.d(TAG, "check what is in flag:" + flag);
    }
    ...
    private void goToprofile(){
        ...
        Intent goToProfileintent = new Intent(PostContentsView_requestActivity.this, ProfileViewActivity.class);
