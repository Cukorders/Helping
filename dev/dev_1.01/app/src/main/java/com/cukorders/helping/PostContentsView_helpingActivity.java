...
public class PostContentsView_helpingActivity extends AppCompatActivity {
        ...
        viewImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(chkimgloaded){
                    ...
                    Intent showImgIntent = new Intent(PostContentsView_helpingActivity.this,PostImgView.class);
                    ...
                    Toast.makeText(PostContentsView_helpingActivity.this, "이미지를 로딩중입니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void displayPost() {
        postRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                //Toast.makeText(PostContentsView_requestActivity.this, "image1 is : this: "+image1, Toast.LENGTH_SHORT).show();
                //Toast.makeText(PostContentsView_requestActivity.this, "image2 is : this: "+image2, Toast.LENGTH_SHORT).show();
                //Toast.makeText(PostContentsView_requestActivity.this, "image3 is : this: "+image3, Toast.LENGTH_SHORT).show();
                ...
                if(!ismatched.equals("default")){
                    ...
                    if(chkmyPosition){
                        ...
                        if(ismatched.equals(mUid)){
                            ...
                            Toast.makeText(PostContentsView_helpingActivity.this, "Current Time is : "+currentTime, Toast.LENGTH_SHORT).show();
                            ...
                            if(chktime){
                                ...
                                missionCancelbtn.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(PostContentsView_helpingActivity.this, "취소할 수 있도록 채팅방으로 이동합니다.", Toast.LENGTH_SHORT).show();
                                        chatCheck_helper();
                                    }
                                });
    ...
    private void goTochklikes() {
        ...
        if (flag == true) {
            ...
            Toast.makeText(PostContentsView_helpingActivity.this, "관심목록에서 삭제되었습니다.", Toast.LENGTH_SHORT).show();
            flag = false;
        } else {
            mylike.setImageResource(R.drawable.heart_icon);
            ...
            Toast.makeText(PostContentsView_helpingActivity.this, "관심목록에 추가되었습니다.", Toast.LENGTH_SHORT).show();
            flag = true;
        }
        Log.d(TAG, "check what is in flag:" + flag);
    }
    ...
    private void goToprofile(){
        ...
        Intent goToProfileintent = new Intent(PostContentsView_helpingActivity.this, ProfileViewActivity.class);
    ...
    private void goToeditprofile(){
        //Todo 사용자 프로필 누르면 해당 사용자 정보 보는 페이지로 이동 , 수정이 아닌 그저 보는 느낌
        Intent goToProfileintent = new Intent(PostContentsView_helpingActivity.this, ProfileActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("clientUid",clientUid);
        Log.d(TAG, "check what is Clientuid_string" + clientUid);
        goToProfileintent.putExtras(bundle);
    ...
    private void goTohelperchat(String chatUid){
        ...
        Intent gohelperChat = new Intent(PostContentsView_helpingActivity.this, ChattingActivity.class);
        Bundle bundle = new Bundle();
    ...
    /*
        private void goToClientchat(String helperuid){
            ...
            Intent goClientChat = new Intent(PostContentsView_helpingActivity.this,ChattingActivity.class );
            Bundle bundle = new Bundle();
            bundle.putSerializable("postUid",postUid);
