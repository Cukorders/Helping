...
public class PostContentsView_helpingActivity extends AppCompatActivity {
    private static final String TAG = "PostContentView_help";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        big_post_title.setText("수행중인 미션");
                        ...
                        if(ismatched.equals(mUid)){
                            ...
                            if(chktime){
                                ...
                                missionCancelbtn.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Toast.makeText(PostContentsView_helpingActivity.this, "취소할 수 있도록\n채팅방으로 이동합니다.", Toast.LENGTH_SHORT).show();
                                        chatCheck_helper();
                                    }
                                });
